...
This is the frozen prospective preregistration for EXP-024. It closes the
protocol to outcome-dependent change before any model, tokenizer,
representation extraction, runner execution, or scientific outcome access.
...
- Hypothesis status: `FROZEN_PROSPECTIVE_NOT_RUN`
- Primary design selected in Task-097B: `B`
- Protocol stage: `FROZEN_NOT_RUN`
...
- Frozen structural schema: `experiments/exp024/data_schema.json`
- Frozen condition panel: `experiments/exp024/condition_panel_spec.json`
...
- Source reviewed candidate SHA-256:
  `46c832b68b6ac95704bf5143badc1431627d7f935648842a78971491b13ee404`
- Repair-log SHA-256:
...
- Candidate validator SHA-256:
  `d2d95333430754fd48889d0840182b0047413c9abcf7d5610392950d74ab5c52`
- R2 Markdown review SHA-256:
  `fce960a3e2f668e9da449f14b2b821af8f8a49a83f4a3ba9a02d4a46ef95f463`
- R2 structured review SHA-256:
  `a7dc98bf58411793106a1a112273be799ea97ee22d2a4e070a0fe109b968344e`

The preregistration is now closed to outcome-dependent change.
...
The next task is `Task 098A — Implement EXP-024 Frozen-Protocol Runner and
Static Tests`. It may implement runner engineering, static tests, and
technical preflight, but must not perform a formal model/data scientific run.
