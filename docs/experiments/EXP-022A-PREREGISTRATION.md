...
Review basis: Task 092C, Task 092E, Task 092F

Repository hygiene completion commit:
`006c73da80c5491cfcf93cdf53978708be52bf60`

Supersedes: `docs/experiments/EXP-022A-PREREGISTRATION-DRAFT.md` v0.2

This document records the frozen EXP-022A scientific protocol. No scientific
redesign is authorized by the freeze action.
...
- `EXP022A_REREVIEW_REQUIRED = false`

Task-092C, Task-092E, and Task-092F prerequisite reviews are complete.
Remaining post-freeze work is runner implementation/static validation and
schema/authorization design.
...
No pre-freeze work remains. Post-freeze work is schema/authorization design.

`EXP022A_PREREGISTRATION_FREEZE_BLOCKED_BY_STATIC_RECONCILIATION = false`


## Prerequisite review completion

`EXP022A_REREVIEW_REQUIRED = false`

Completed prerequisite review items:

1. independent scientific/statistical review (Task 092C)
2. independent v0.2 freeze-candidate rereview (Task 092E)
3. technical consistency of exact-test definitions
4. technical consistency of classifier constructor under frozen sklearn version
5. targeted diff rereview (Task 092F)

Post-freeze work: schema/authorization design and runner implementation/static validation.
...
```text
EXP022A_PREREGISTRATION_VERSION = 1.0
EXP022A_PREREGISTRATION_STATUS = FROZEN
...
EXP022A_OPEN_REVIEW_ITEMS_PRESENT = false
