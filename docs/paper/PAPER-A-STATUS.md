...
## Task 099D Post-Revision Re-evaluation

- `POST_REVISION_REREVIEW_COMPLETE = true`
- `REVISED_MANUSCRIPT_VERDICT = BORDERLINE`
- `MAJOR_ISSUES_RESOLVED = 3`
- `MAJOR_ISSUES_PARTIAL_NONBLOCKING = 2`
- `MAJOR_ISSUES_STILL_MAJOR = 0`
- `FIGURE_PLAN_READY = true`
- `REFERENCE_POSITIONING_READY = true`
- `NEW_EXPERIMENT_REQUIRED_FOR_CORE_CLAIM = false`
